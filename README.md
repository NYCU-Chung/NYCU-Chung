...
|---------|-------|----|-|
| [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid) | 87K+ | [#7589](https://github.com/mermaid-js/mermaid/pull/7589) | Fixed block-beta column width normalization regression |
| [lightpanda-io/browser](https://github.com/lightpanda-io/browser) | 27K+ | [#2091](https://github.com/lightpanda-io/browser/pull/2091) | Fixed cookie PSL validation (RFC 6265bis) |
...
| 專案 | Stars | PR | 說明 |
|------|-------|----|-|
| [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid) | 87K+ | [#7589](https://github.com/mermaid-js/mermaid/pull/7589) | 修復 block-beta 欄寬正規化回歸 |
| [lightpanda-io/browser](https://github.com/lightpanda-io/browser) | 27K+ | [#2091](https://github.com/lightpanda-io/browser/pull/2091) | 修復 cookie PSL 驗證 (RFC 6265bis) |
