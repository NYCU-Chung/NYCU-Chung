...
| [**cc-statusline**](https://github.com/NYCU-Chung/cc-statusline) | Claude Code 的完整 statusline 儀表板 — session、配額、agents、MCP、訊息歷史 | ![Stars](https://img.shields.io/github/stars/NYCU-Chung/cc-statusline?cacheSeconds=3600) ![Forks](https://img.shields.io/github/forks/NYCU-Chung/cc-statusline?cacheSeconds=3600) |
